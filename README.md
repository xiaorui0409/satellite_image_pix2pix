...
In the first application, our goal is to improve the resolution of blurry satellite images. 
...
In the second application, we can use the trained model to simulate forest recovery from before to after recovery states.
